#
#  Be sure to run `pod spec lint xbTextView.podspec' to ensure this is a
...
一个带placeholder的textView，很好用！
  ...
  spec.homepage     = "https://github.com/FXiaobin/xbTextView"
  ...
  spec.source       = { :git => "https://github.com/FXiaobin/xbTextView.git", :tag => "#{spec.version}" }
